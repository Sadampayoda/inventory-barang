            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="card-title">Catatan Piutang</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <!-- Input search -->
                                <a href="/piutang/tambah" class="btn btn-primary"><i class="fas fa-plus"></i> Insert Data</a>
                            </div>
                            <div class="col-md-6">
                                <!-- Input search -->
